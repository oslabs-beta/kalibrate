...
app.post('/api/:clientId/partitions', authController_1.default.verifySessionCookie, kafkaController_1.default.getCachedClient, clusterController_1.default.getClientConnection, kafkaController_1.default.cacheClient, kafkaController_1.default.getCachedClient, topicController_1.default.addPartitions, adminController_1.default.getTopicData, (req, res) => {
    return res.status(200).json(res.locals.topicData);
});
...
app.post('/api/password/forgot', authController_1.default.sendResetPassword, (req, res) => {
    return res.sendStatus(200);
});
app.patch('/api/password/reset', authController_1.default.resetPassword, (req, res) => {
    return res.sendStatus(200);
});
app.post('api/alert', authController_1.default.verifySessionCookie, adminController_1.default.sendAlertEmail, (req, res) => {
    return res.sendStatus(200);
});
// Catch all handler
app.use('*', (req, res) => {
